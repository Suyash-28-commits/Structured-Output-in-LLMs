...
class Review(BaseModel):
    ...
    summary : str = Field(description="Give a brief summary")
    sentiment : Literal["pos","neg"] = Field(description="Give sentiment of the review with either positive,negative or neutral")
    pros : Optional[list[str]] = Field(default=None,description="Write all the pros in the review in the form of a list")
    cons : Optional[list[str]] = Field(default=None,description="Write all the cons in the review in the form of a list")
